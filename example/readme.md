...
### 1.4 Comment
Получается много избыточных линий (соединений): с одной стороны "одна арх-запись" = один "скволной" путь, т.е. можно выделив строку подсветить весь набор стрелок к ней.  
