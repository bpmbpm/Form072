...
Опции:
- При выборе File (inData: 'File') есть примеры: f072r7v2.txt (16 строк/ CI) и f072r7v3.txt (40 строк/ CI), см. https://github.com/bpmbpm/Form072/tree/main/example
...
Наборы данных DATASET_072v1 (8 CI); DATASET_072v2 (16 CI); DATASET_072v3 (40 CI) и файлы f072r7v2.txt / f072r7v3.txt в арх-строках содержат значимые поля **только** для позиций, выводимых на граф (была подставлена руками только часть позиций).
...
```
можно включить режим edit заменой в адресной строке на
```
